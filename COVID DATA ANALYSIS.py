...
t=Text(window, height=1 ,width=30,bg='cyan', bd=0, fg='forestgreen', font=('copperplate gothic bold',72))
name='TRACK COVID'
t.insert(END, name)
...
def about():
    ...
    text0=Text(top0, height=20, width=100,font=('Berlin Sans FB Demi', 15))
...
b1=tkinter.Button(frame, text='ABOUT', fg='indigo', bg='yellow', activebackground='Blue', height=5, width=30, font=('ms sans serif',16), command=about).pack(side='top', anchor='n')
...
def donate():
    top3=Toplevel(bg='violet')
    top3.title('DONATIONS AND RELIEF FUNDS')
    head=Text(top3, bg='violet',fg='crimson', height=1, width=80, bd=0, font=('Copperplate Gothic Bold', 40))
    txt1=Text(top3, bg='violet', fg='teal', height=1, width=80, bd=0, font=('Footlight MT Light', 20))
    txt2=Text(top3, bg='violet', fg='teal', height=1, width=80, bd=0, font=('Footlight MT Light', 20))
    txt3=Text(top3, bg='violet', fg='teal', height=1, width=80, bd=0, font=('Footlight MT Light', 20))
    txt4=Text(top3, bg='violet', fg='teal', height=1, width=80, bd=0, font=('Footlight MT Light', 20))
    txt5=Text(top3, bg='violet', fg='teal', height=1, width=80, bd=0, font=('Footlight MT Light', 20))
